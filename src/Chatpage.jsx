                ...
                >
                  <img
                    ...
                    onClick={(e) => {
                      ...
                      setModalImageSrc(chat.profilePic);
        ...
        >
          {searchView === "icon" && (
            <div className="d-flex justify-content-end align-items-center mb-3 me-3">
              ...
              />
              <i
                className="bi bi-three-dots-vertical mt-2 mb-2 me-3"
                title="More"
      ...
      {chatView == "chat" && (
        <div className="d-flex flex-grow-1">
          ...
          >
            ...
            <div
              className="d-flex align-items-center mt-3 border-top pt-3 px-2"
              style={{
            ...
            >
              ...
              <div className="dropdown me-2">
                <i
                  className="bi bi-paperclip fs-4"
                  style={{ cursor: "pointer" }}
                  data-bs-toggle="dropdown"
                  aria-expanded="false"
                ></i>
