...
export default function Chatpage(props) {
  ...
  // 📌 DUMMY CHAT DATA (for local testing - replace with server data later)
  const dummyChats = [
    {
      id: 1,
      name: "Rutuja Dabhade",
      ...
      time: "10:45 AM",
      profilePic: "/images/icons/user.png",
    },
    {
      id: 2,
      name: "Sakshi Chavan",
      ...
      {searchView != "settings" && (
        ...
        >
          ...
          <div className="d-flex justify-content-between align-items-center p-3 border-bottom">
            <h4 className="m-0 fw-bold">Bingo</h4>
            ...
            <ul className="list-group">
              {dummyChats.map((chat) => (
                <li
                  ...
                  onClick={() => console.log("Open chat with", chat.name)}
                >
                  <img
                    src={chat.profilePic}
                    alt={chat.name}
